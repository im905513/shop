                        ...
                        <div class="table-responsive">
                            ...
                            <?php if(isset($content_result)):?>
                                ...
                                <tr>
                                    ...
                                    <th>訂購人</th>
                                    <td>
                                        <?php echo $content_result->member_name;?>
                                    </td>
                                    <th>訂購日期</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="order_vat_number" value="<?php echo $content_result->order_vat_number?>" id="order_vat_number"> 
                                        </div>
                                    </td>
                                    <th>發票抬頭</th>
                                    <td colspan="3">
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="order_invoice_title" value="<?php echo $content_result->order_invoice_title?>" id="order_invoice_title"> 
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="order_addressee_name" value="<?php echo $content_result->order_addressee_name?>" id="order_addressee_name"> 
                                        </div>
                                    ...
                                    <td colspan="3">
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="order_addressee_mobile" value="<?php echo $content_result->order_addressee_mobile?>" id="order_addressee_mobile"> 
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="order_addressee_addr" value="<?php echo $content_result->order_addressee_addr?>" id="order_addressee_addr"> 
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <th>運送狀態</th>
                                    <td>
                                        <select name="order_ship_status" id="order_ship_status" class="form-control">
                                            <option value="0">未運送</option>
                                            <option value="1">已運送</option>
                                        </select>
                                    </td>
                                    <th>發票狀態</th>
                                    <td>
                                        <select name="order_inv_status" id="order_inv_status" class="form-control">
                                            <option value="0">未開立</option>
                                            <option value="1">已開立</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="order_note" value="<?php echo $content_result->order_note?>" id="order_note"> 
                                        </div>
